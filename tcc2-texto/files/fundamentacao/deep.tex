...
\input{./files/fundamentacao/cnn}

\subsection{Arquiteturas Canônicas de Redes Neurais Convolucionais} \label{subsec:arquiteturas}
\input{./files/fundamentacao/cnn/arquiteturas}

\subsection{\textit{Transfer Learning}} \label{subsec:transfer}
\input{./files/fundamentacao/transfer}
