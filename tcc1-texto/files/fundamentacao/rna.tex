...
A função $f$ é chamada de \emph{função de ativação} e fornece a resposta de um neurônio para uma dada entrada. Esta função precisa ser monotônica e contínua, podendo comumente ser as funções identidade, sigmóide, tangente hiperbólica, ou a retificada linear (ReLU) \todo{Citar JAI}. Estas funções encontram-se representadas na Figura \ref{img:funcs_ativacao}.
...
% Aplicações
\todo{Tentar ser mais geral, mas sem spoilers}
